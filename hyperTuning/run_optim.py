...
parser.add_argument("-t", "--trails", help = "Number of trails", type=int, default=10)
parser.add_argument("-e", "--early_stop", help = "Number of early stop epochs", type=int, default=3)
...
fixed_config_file_list = [os.path.join('configs','config_boardgames.yaml')]
